...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source Coded By JM \nYoutube : @AsmrProg');
    ...
    const options = {
		...
		'X-RapidAPI-Key': '93d8ceae4cmshd8fa9cc622a0be7p166e7fjsn7c63170a15bc',
		'X-RapidAPI-Host': 'open-ai21.p.rapidapi.com'
        //if you want use officail api
        /*
        'content-type': 'application/json',
		'X-RapidAPI-Key': '93d8ceae4cmshd8fa9cc622a0be7p166e7fjsn7c63170a15bc',
		'X-RapidAPI-Host': 'open-ai21.p.rapidapi.com'
        */
        ...
        // if tou want use official api you need have this body
        // `{"messages":[{"role":"user","content":"${message}}]}`
    };
    fetch('https://open-ai21.p.rapidapi.com/conversationgpt35', options).then((response) => response.json()).then((response) =>{
